...
- Проверка, существует ли пользователь:
  ...
  - Если не находим пользователя, то записываем информацию об этом в лог файл
   ----
8. В зависимоти от того, в какой из блоков попала выгрузка могут производится следующие действия:
 - При восстановлении, создании новой учётной записи - [функция отправки информационного сообщения на телефон сотрудника - SMS-Sender](#функция-SMS-Sender)
